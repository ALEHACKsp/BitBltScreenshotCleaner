...
BYTE* TrampHook32(BYTE* src, BYTE* dst, const uintptr_t len)
{
	...
	//Create trampoline
	BYTE* pTrampoline = (BYTE*)VirtualAlloc(0, len, MEM_COMMIT | MEM_RESERVE, PAGE_EXECUTE_READWRITE); //TODO:need to free this
...
{
	this->src = (BYTE*)GetProcAddress(GetModuleHandleA(modName), exportName);
	this->dst = dst;
	this->len = len;
	this->pTrampoline = pTrampoline;
}
...
Hook::~Hook()
{
	...
	{
		VirtualFree(pTrampoline, 0, MEM_RELEASE); //TODO: Test this
	}
}